...
public:
  ...
  GATreeBASE(){rt=nullptr; sz=0; dpth=0; csz=0; cdpth=0;}
...
public:
  GATreeIterBASE(){node=nullptr; tree=nullptr;}
  ...
  GANodeBASE * child(){return(node ? (node=node->child) : nullptr);}
